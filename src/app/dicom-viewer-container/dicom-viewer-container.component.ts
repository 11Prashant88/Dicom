...
@Component({
  selector: 'app-dicom-viewer-container',
  templateUrl: './dicom-viewer-container.component.html',
  styleUrls: ['./dicom-viewer-container.component.scss'],
})
export class DicomViewerContainerComponent implements OnInit {
